...
5. [web/index.html](web/index.html) subscribes to Supabase realtime and shows a live dashboard of the counts.
...
Open [web/index.html](web/index.html) in a browser for a live-updating dashboard of the counts.
